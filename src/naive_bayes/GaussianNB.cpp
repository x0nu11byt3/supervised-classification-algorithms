...
namespace ml {
    ...
    */
    ...
    /*
     Calculate the natural logarithm of the probability density function (PDF)
     of a normal (Gaussian) distribution with mean mean and variance var, evaluated at x.
     */
    ...
    /*
     Classify a new instance (described by features) using the trained model.
     */
